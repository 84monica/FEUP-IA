...
class SceneAStar(Scene):
    ...
    def __init__(self, director):
        ...
        # Define the texts
        self.ai_text = self.font.render('A* Search', True, self.white)
        ...
        self.dfs_text_one = self.small_font.render('Normal 1', True, self.white)
        self.dfs_text_two = self.small_font.render('First Search', True, self.white)

        self.id_text_one = self.small_font.render('Normal 2', True, self.white)
        ...
        self.dfs_text_one_rect = (800, 355)

        self.id_text_one_rect = self.id_text_one.get_rect()
        self.id_text_one_rect = (500, 535)
